...
b. Using a seed of 18, simulate the benchmark of what we should see for our sample proportion if the true population percentage of Americans who know the answer to this question is 75%. Visualize the resulting distribution.
...
c. Create a table summarizing the relationship. Also calculate the difference between the proportion (female - male) who say "yes". Save this in a variable called `obs_diff`
