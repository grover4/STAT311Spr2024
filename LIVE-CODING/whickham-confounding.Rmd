...
4. Below is a summary table obtained from the dataset. Use R as a calculator to compare the % of smokers who are alive with the % non-smokers who are alive.  Does the relationship between smoking and survival match with your expectation? 
...
6. What do your answers to part 5 tell you about the variable `age` in this data set. How do they help you make sense of the counter-intuitive result in part 4?
