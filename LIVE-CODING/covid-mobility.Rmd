...
Please introduce yourselves to each other and then assign the following roles to members of the group.
 
  - **Moderator**: a project manager who facilitates the conversation and ensures everyone is given a chance to speak.
  
  - **Timekeeper**: you have about 20 minutes to work on this.
  
  - **Reporter**: after we regroup as a class, reporter summarizes the group's discussion if your group is called.
...
Which countries are you most curious about? Pick two countries you wish to compare, but first check that the country is in the dataset by using the interactive table in the appendix. Take a look at the code to see where the country names are specified. Change them to the two you are interested in. Knit again and voila!  
